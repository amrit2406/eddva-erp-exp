...
const navItems: NavItem[] = [
  ...
  { 
    ...
    children: [
      ...
      { path: '/canteen/dashboard', label: 'Dashboard', icon: LayoutDashboard },
  ...
  },
  {
    ...
    children: [
      ...
      { path: '/library/dashboard', label: 'Dashboard', icon: LayoutDashboard },
  ...
  },
  {
    ...
    children: [
      ...
      { path: '/sports/dashboard', label: 'Dashboard', icon: LayoutDashboard },
