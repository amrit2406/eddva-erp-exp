      ...
      <table className="w-full">
        <thead>
          <tr className="border-b border-slate-200 bg-slate-50">
            ...
            <th className="text-left py-3 px-4 text-sm font-semibold text-slate-700">Complainant</th>
        ...
        <tbody>
          {mockComplaints.map((complaint) => (
            <tr key={complaint.id} className="border-b border-slate-100 hover:bg-slate-50">
              <td className="py-3 px-4 text-sm text-slate-900 font-medium">{complaint.complaintNumber}</td>
              <td className="py-3 px-4 text-sm text-slate-900">{complaint.complainantName}</td>
              <td className="py-3 px-4 text-sm text-slate-600">{complaint.phone}</td>
              <td className="py-3 px-4 text-sm text-slate-600 capitalize">{complaint.category}</td>
              <td className="py-3 px-4 text-sm text-slate-600">{complaint.subject}</td>
              <td className="py-3 px-4">
                <PriorityBadge priority={complaint.priority} />
              </td>
              <td className="py-3 px-4 text-sm text-slate-600">{complaint.assignedToName || '-'}</td>
              <td className="py-3 px-4">
