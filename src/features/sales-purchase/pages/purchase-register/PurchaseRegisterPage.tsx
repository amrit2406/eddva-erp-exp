...
import PurchaseRegisterTable from '../../components/purchase-register/PurchaseRegisterTable';
import PurchaseRegisterFilters from '../../components/purchase-register/PurchaseRegisterFilters';

export default function PurchaseRegisterPage() {
  // Calculate totals from mock data
  const totalTaxable = 60000;
  const totalTax = 10800;
  const totalGrand = 70150;
    ...
    <div className="space-y-6">
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
          ...
          <p className="text-slate-600 mt-1">Statutory report of posted vendor invoices</p>
        </div>
      </div>
