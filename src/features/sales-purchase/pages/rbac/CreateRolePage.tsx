...
export default function CreateRolePage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (grantablePermissions.length === 0) {
      setError('You can only assign permissions that your account already has in the sales & purchase module.');
      return;
    }
    ...
    return (
      <div className="space-y-6">
        <div>
          ...
          <p className="text-slate-600 mt-1">Create a new sales & purchase role with permissions</p>
        </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full px-3 py-2 border border-slate-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                  placeholder="e.g. Creates and submits purchase orders, records GRNs"
                  required
                />
              </div>
            </div>
