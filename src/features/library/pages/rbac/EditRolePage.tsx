...
export default function EditRolePage() {
  ...
  const save = useMutation({
    ...
    onSuccess: (_, data) => {
      ...
      queryClient.invalidateQueries({ queryKey: ['library', 'role', id] });
